...
let input: any;
let AES_256_CTR_TEST = new Circuit();
...
const ZK = function () {
  const setupInput = async () => {
    ...
    const ks = [
      1962153145, 3621906731, 3712678050, 3286144703, 1815899717, 1472326661, 507853, 584243966,
      3479675375, 411453636, 3318526054, 101852889, 66427248, 1412724085, 1412680376, 1994461254,
      2506053927, 2379813347, 1209377157, 1309116252, 741379642, 2013592399, 741814775, 1523982769,
      1575071710, 3493379645, 2553094072, 3593115876, 3671443539, 2731619100, 2397438699,
      3559924570, 3819547632, 865146317, 2881227381, 2107019921, 625313746, 2274669774, 158512677,
      3712128383, 828934090, 49910279, 2839910514, 3570600675, 1831067843, 3937883149, 3821396520,
      1049065303, 1792708639, 1747124760, 3244726890, 364220553, 888569956, 3728856169, 1032074817,
      50544918, 765586396, 1166207428, 2229564334, 2438062887,
    ];
  ...
  return (
    <div
      ...
      `}
    >
      <button onClick={setupInput}>setupInput</button>
      <button onClick={generateProof}>generateProof</button>
      <button onClick={verifyProof}>verifyProof</button>
    </div>
  );
};
export default ZK;
